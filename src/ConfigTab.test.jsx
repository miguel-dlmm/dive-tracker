...
// "Configuración → Administración → Experimental → Preview de diseños" debe
// verse solo para superadmin (más restrictivo que el resto de secciones de
// admin, que ya se ven con is_admin). Ver ExperimentalLab / SUPERADMIN_SECTIONS
// en ConfigTab.jsx — el laboratorio en sí (src/lab/) tiene su propia
// cobertura en DesignLabShell.test.jsx.
describe("ConfigTab — sección Experimental (solo superadmin)", () => {
