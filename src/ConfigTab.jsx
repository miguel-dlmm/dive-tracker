...
import {
  ...
  CreditCard, Flag, DollarSign, Palette, SlidersHorizontal, Users, Shield, ShieldCheck, FlaskConical,
} from "lucide-react";
...
// superadmin, más restrictivo que el resto de "Administración".
...
const SUPERADMIN_SECTIONS = [
  { key: "experimental", label: "Experimental", icon: FlaskConical, description: "Laboratorio visual, solo maquetas" },
];
  ...
  if (section == null) {
    return (
      <div className="space-y-5" {...backProps}>
        ...
        {isAdmin && <ConfigMenuGroup title="Administración" items={isSuperadmin ? [...ADMIN_SECTIONS, ...SUPERADMIN_SECTIONS] : ADMIN_SECTIONS} onSelect={setSection} />}
      </div>
    );
  }
