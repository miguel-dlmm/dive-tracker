...
export default function ComisionesTab({ schools, activities, paymentTypes, paymentStatuses, currencies, commissionRates, comisiones, appSettings, userId, accentColor = TEAL, autoOpenSheet = false, onAutoOpened }) {
