...
export const HELP_CATEGORIES = [
  ...
  },
  {
    ...
    label: "Mi perfil",
    description: "Avatar, datos, moneda favorita y contraseña",
    articles: [
      {
        id: "perfil-referencia",
        title: "Mi perfil, de un vistazo",
        summary: "Tu avatar, tus datos, tu moneda favorita y tu contraseña — todo en un mismo sitio, accesible desde tu nombre en la cabecera.",
        whatYouCanDo: "Toca tu avatar o tu nickname, arriba a la derecha en cualquier pantalla, para entrar en Mi perfil: cambiar tu avatar (icono y color), editar nombre/apellidos/nickname, elegir tu moneda favorita, cambiar tu contraseña, y eliminar tu cuenta si alguna vez lo necesitas.",
        whenToUseIt: "Cuando quieras personalizar tu cuenta, corregir un dato, o cambiar la contraseña sin tener que cerrar sesión y pasar por \"olvidé mi contraseña\".",
        steps: [
          "Toca el avatar/nickname de la cabecera para entrar en Mi perfil.",
          "El lápiz sobre el avatar abre el selector de icono y color — el cambio se guarda al elegir, sin botón \"Guardar\" aparte.",
          "\"Editar\" en Datos personales abre nombre, apellidos y nickname; el nickname no puede llevar \"@\" ni coincidir con el de otra cuenta.",
          "Moneda favorita se usa como respaldo en Ajuste de curso cuando no hay una tarifa que la determine — el resto de movimientos siempre usan la moneda de su propia tarifa.",
        ],
        tips: [
