...
export default function WorkLogTab({ schools, activities, paymentTypes, paymentStatuses, currencies, rates, worklog, appSettings, accentColor = TEAL, autoOpenSheet = false, onAutoOpened }) {
