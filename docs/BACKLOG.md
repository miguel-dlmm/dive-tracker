...
| Cambiar nomenclatura global de "Actividades" a "Cursos" — completar fase 1 en Resumen | "Actividad" es un término genérico que no coincide con cómo piensa el instructor — Open Water, Advanced, Rescue y las especialidades son "cursos", no "actividades" en su cabeza. Fase 1 (solo texto) ya aplicada en Configuración/Tarifas/Home (2026-08-29, ver `docs/ADR/0008-rediseno-configuracion.md`); queda pendiente "Por actividad" en las tarjetas de desglose de Resumen | Medio (claridad de dominio, no cambia ningún cálculo) | XS (solo texto, ya en el archivo que toca rediseñarse) | Bajo | Se hará junto al rediseño de Resumen para no tocar ese archivo dos veces por motivos distintos |
